...
Catch the live preview, bundle samples, and everything else in the super comprehensive [Online Documentation](https://doc.wpclever.net/woosb/) now.

= Basics to create a smart product bundle =

https://www.youtube.com/watch?v=_CULYbTT0k0
...
= 5.6.5 =
* Fixed: Prevent changing bundle SKU when changing the bundled product
* Fixed: Removed WC_Email::get_blogname()
* Fixed: Price error when using subscription product
* Fixed: Some minor JS issues

= 5.6.4 =
* Fixed: Bundle stock status when one of bundled product is unpurchasable

= 5.6.3 =
* Fixed: Remove limitation when showing products

= 5.6.2 =
* Updated: Optimized the code

= 5.6.1 =
* Fixed: Add to cart for the same products
...
* Added: Private status for bundled products
* Fixed: Some minor CSS issues

= 5.5.3 =
* Fixed: Out of stock products on the search result
* Fixed: Remove all orphaned bundled products

= 5.5.2 =
* Updated: Optimized the code

= 5.5.1 =
* Fixed: Low-stock and out-of-stock email issue
...
= 5.3.7 =
* Added: Filter hook 'woosb_container_selector'
* Updated: Compatible with WooCommerce 4.7.1
...
= 5.3.3 =
* Fixed: Error "has not enough stock"

= 5.3.2 =
* Updated: Optimized the code

= 5.3.1 =
* Fixed: Remove the sale price if the discount percentage or amount is empty

= 5.3.0 =
* Fixed: Calculate bundled prices from Regular price

= 5.2.7 =
* Updated: Compatible with WordPress 5.5 & WooCommerce 4.3.2

= 5.2.6 =
* Added: Swedish translation (Thanks to Tony Andrén)
* Fixed: Bundle's stock when choosing "Exclude un-purchasable products"

= 5.2.5 =
* Fixed: JS error for WPC Smart Quick View

= 5.2.4 =
* Fixed: JS error on FireFox/Edge browser

= 5.2.3 =
* Fixed: Compatible with Elementor
* Fixed: Duplicate bundle when adding a bundle to order manually
...
* Fixed: Price doesn't change when the bundled product' price is zero
...
= 4.0.2 =
* Added: Coupon restrictions

= 4.0.1 =
* Fixed: Wrong bundle price on the cart

= 4.0.0 =
* Updated: Compatible with WooCommerce 4.0

= 3.9.0 =
* Fixed: JS show bundle' total
* Added: New action hooks woosb_before_item & woosb_after_item
...
= 3.3.2 =
* Added: Romanian translation (thanks to Andrei Flavius)
