...
(function($) {
  ...
  $(document).on('click touch', '#woosb_search_settings_update', function(e) {
    ...
    var data = {
      ...
      limit: $('input[name="_woosb_search_limit"]').val(),
      sku: $('select[name="_woosb_search_sku"]').val(),
      id: $('select[name="_woosb_search_id"]').val(),
      exact: $('select[name="_woosb_search_exact"]').val(),
      sentence: $('select[name="_woosb_search_sentence"]').val(),
      same: $('select[name="_woosb_search_same"]').val(),
      types: $('select[name="_woosb_search_types[]"]').val(),
    };
