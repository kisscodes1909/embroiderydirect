...
class THWEPO {
	...
	private function set_compatibility(){
		...
		// Loads the integration with the Aelia Currency Switcher
		// @since 3.1.7
		if( THWEPO_Utils::is_aelia_currencyswitcher_plugin_active() && apply_filters( 'thwepo_aelia_currency_switcher_compatibility', true ) ) {
			WEPO_Aelia_Currency_Switcher_Handler::instance();
		}

		// Loads the integration with the WOOCS Currency Switcher
		// @since 3.1.7
		if( THWEPO_Utils::is_woocs_currencyswitcher_plugin_active() && apply_filters( 'thwepo_woocs_currency_switcher_compatibility', true ) ) {
			WEPO_Woocs_Currency_Switcher_Handler::instance();
		}
	}
