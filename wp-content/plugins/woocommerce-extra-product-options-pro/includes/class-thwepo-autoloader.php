...
class THWEPO_Autoloader {
	...
	private $class_path = array(
		...
		'wepo_product_field_email' => 'includes/model/fields/class-wepo-field-email.php',
		'wepo_product_field_url' => 'includes/model/fields/class-wepo-field-url.php',
		'wepo_product_field_range' => 'includes/model/fields/class-wepo-field-range.php',
		...
		'wepo_product_field_daterangepicker' => 'includes/model/fields/class-wepo-field-daterangepicker.php',
		...
		'wepo_product_field_colorpalette' => 'includes/model/fields/class-wepo-field-colorpalette.php',
		'wepo_product_field_imagegroup' => 'includes/model/fields/class-wepo-field-imagegroup.php',
		'wepo_product_field_separator' => 'includes/model/fields/class-wepo-field-separator.php',
		'wepo_product_field_switch' => 'includes/model/fields/class-wepo-field-switch.php',
		...
		// @since 3.1.7
		'wepo_aelia_currency_switcher_handler' => 'includes/compatibility/class-wepo-aelia-currency-switcher-handler.php',

		// Aelia Currency Switcher integration
		// @since 3.1.9
		'wepo_woocs_currency_switcher_handler' => 'includes/compatibility/class-wepo-woocs-currency-switcher-handler.php',
	);
